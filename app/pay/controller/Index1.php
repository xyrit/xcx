...
//		$url = 'https://api.youngport.com.cn/';
		...
		if(empty($post)){
				$post = '{"auth_code":"134851930416582029","bill_create_ip":"192.168.2.150","device_no":"11","goods_desc":"goods","nonce_str":"123456","pp_trade_no":"20170914163811221116090000562B","total_fee":"1","sign":"6F9F55A8C0B83E4C08AD1B944DF45DDB"}';
	...
	//	$post = 'https://api.youngport.com.cn';
		...
		($res = db('merchants_cate')->where(array('merchant_id'=>$pay['merchant_id']))->find()) || $this->err('merchants is empty');
