...
//				        $param['notify_url'] = 'https://mp.youngport.com.cn/index/Notify/ms';
//				        $param['spbill_create_ip'] = '127.0.0.1';
//				        $param['trade_type'] = 'JSAPI';
//				        $param['wxapp'] = true;
//				        $param['sub_openid'] = $openid;
//				        $param['sign'] = $this->zs_sign($param,'A2DF7476B30CD384BF04EF0E01B5AF7C');
...
//				        p($xmlData);
//				        $result=httpRequst_pay($url, $xmlData);
//				        print_r($result);
