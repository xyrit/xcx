...
-- -----------------------------
INSERT INTO `onethink_admin` VALUES ('1', 'admin111', 'bbad8d72c1fac1d081727158807a8798', '天才888', '0', '', '0', '32', '127.0.0.1', '1478744039', '2130706433', '1481851505', '1');
...
CREATE TABLE `onethink_model` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='文档模型表';
